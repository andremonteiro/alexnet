...
# Realiza a leitura de um suconjunto de amostras
totalAmostras = 1000
numeroLeituras = 0
...
print("Realizando leitura das features...")
amostras = os.listdir(directory)
for item in amostras:
	if (numeroLeituras < totalAmostras):
		print("Lendo amostra "+str((numeroLeituras+1))+". Faltam "+str(totalAmostras-numeroLeituras))
		...
		amostras[classe] = int(amostras[classe]) + 1
		y.append(classe)
